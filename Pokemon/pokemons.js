...
module.exports.run = async(client, message, args) => {
    ...
    randomimg = [
        ...
        "Florges Red Flower.png","Skiddo.png","Gogoat.png","Pancham.png","Pangoro.png","Furfrou.png","Espurr.png","Meowstics.png","Honedge.png","Doublade.png","Aegislash.png","Spritzee.png",
        ...
        "Yungoos.png","Gumshoos.png","Grubbin.png","Charjabug.png","Vikavolt.png","Crabrawler.png","Crabominable.png","Oricorio.png","Cutiefly.png","Ribombee.png","Rockruff.png",
        "Lycanroc.png","Wishiwashi.png","Mareanie.png","Toxapex.png","Mudbray.png","Mudsdale.png","Dewpider.png","Araquanid.png","Fomantis.png","Lurantis.png","Morelull.png",
        ...
        "Sandygast.png","Palossand.png","Pyukumuku.png","Type Null.png","Silvally.png","Minior.png","Komala.png","Turtonator.png","Togedemaru.png","Mimikyu Disguised Form.png","Bruxish.png","Drampa.png",
        ...
        "Kubfu.png","Urshifu.png","Zarude.png","Regieleki.png","Regidrago.png","Glastrier.png","Spectrier.png","Calyrex.png","Wyrdeer.png","Basculegion.png","Kleavor.png","Overqwil.png",
        "Ursaluna.png","Basculegion.png","Basculegion♂.png","Basculegion♀.png","Sneasler.png","Enamorus Incarnate Form.png",
        /*Ninth gen*/
        "Sprigatito.png","Fuecoco.png","Quaxly.png","Koraidon.png","Miraidon.png",
        /*Alternative Forms*/
        ...
        "Dialga Origin Form.png","Enamorus Therian Form.png","Mewtwo Armored.png",
        /*Unowns*/
        ...
        "Hisui Sliggoo.png","Hisui Goodra.png","Hisui Arcanine.png",".png","Hisui Electrode.png","Hisui Sneasel.png","Hisui Avalugg.png",
        /*Mega*/
